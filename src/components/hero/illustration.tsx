        ...
        <svg width="124" height="64" viewBox="0 0 124 64" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient x1="0%" y1="50%" x2="114.418%" y2="50%" id="squares-1-a">
              <stop stopColor="#00ffaa" offset="0%" />
        ...
        <svg width="400" height="400" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            >
              ...
              <stop stopColor="#81adf8" offset="100%" />
            </radialGradient>
          </defs>
      ...
      >
        <svg width="200" height="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            >
              <stop stopColor="#eef2ff" offset="0%" />
              <stop stopColor="#dae1fd" offset="34.827%" />
              <stop stopColor="#d1d5ff" offset="100%" />
            </radialGradient>
          </defs>
      ...
      <div ref={addToScrollRevealTwoRef} className="hero-illustration-browser drop-shadow-2xl">
        ...
        >
          ...
          <g fill="none" fillRule="evenodd">
            ...
            <svg width="1000" height="480" viewBox="0 0 800 450" xmlns="http://www.w3.org/2000/svg">
              <image x="-160" y="-10" width="800" height="450" href={imgLogo} />
            </svg>
      ...
      >
        <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            >
              <stop stopColor="#eef2ff" offset="0%" />
              <stop stopColor="#d4f6ff" offset="34.827%" />
              <stop stopColor="#b5ecff" offset="100%" />
            </radialGradient>
            <filter
              x="-500%"
              y="-500%"
      ...
      >
        <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            >
              <stop stopColor="#eef2ff" offset="0%" />
              <stop stopColor="#dbf4ff" offset="34.827%" />
              <stop stopColor="#d9f7ff" offset="100%" />
            </radialGradient>
            <filter
              x="-500%"
              y="-500%"
